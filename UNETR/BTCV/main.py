...
# --checkpoin=./runs/Task193_Ureter/model.pt'
parser = argparse.ArgumentParser(description='UNETR segmentation pipeline')
parser.add_argument('--checkpoint', default=None, help='start training from saved checkpoint')
parser.add_argument('--logdir', default='Task173_Ureter', type=str, help='directory to save the tensorboard logs')
parser.add_argument('--pretrained_dir', default='./pretrained_models/', type=str, help='pretrained checkpoint directory')
parser.add_argument('--data_dir', default="/data/sukmin/monai_dataset/Task163_Ureter", type=str, help='dataset directory')
...
def main():
    ...
    # args.logdir = '/data/sukmin/monai_dataset' + args.logdir
